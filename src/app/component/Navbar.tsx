...
export default function Navbar() {
  return (
    <nav className="w-full sticky top-0 px-12 z-50 py-6 drop-shadow-md flex items-center justify-between bg-white">
      <Link className="font-extrabold text-3xl" href={"/"}>
        LOKAKULTUR
      </Link>
      <div className="flex font-semibold text-md gap-6 justify-center items-center px-8">
